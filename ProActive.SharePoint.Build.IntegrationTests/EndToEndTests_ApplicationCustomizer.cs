namespace ProActive.SharePoint.Build.IntegrationTests
{
    ...
    public class EndToEndTests_ApplicationCustomizer
    {
        private readonly string SourceFolder = Path.GetFullPath($"Artifacts{Path.DirectorySeparatorChar}EndToEnd{Path.DirectorySeparatorChar}ApplicationCustomizer{Path.DirectorySeparatorChar}Source");
        private readonly string OutputFolder = Path.GetFullPath($"Artifacts{Path.DirectorySeparatorChar}EndToEnd{Path.DirectorySeparatorChar}ApplicationCustomizer{Path.DirectorySeparatorChar}Target");
