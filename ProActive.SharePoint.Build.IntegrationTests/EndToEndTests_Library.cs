namespace ProActive.SharePoint.Build.IntegrationTests
{
    ...
    public class EndToEndTests_Library
    {
        private readonly string SourceFolder = Path.GetFullPath($"Artifacts{Path.DirectorySeparatorChar}EndToEnd{Path.DirectorySeparatorChar}Library{Path.DirectorySeparatorChar}Source");
        private readonly string OutputFolder = Path.GetFullPath($"Artifacts{Path.DirectorySeparatorChar}EndToEnd{Path.DirectorySeparatorChar}Library{Path.DirectorySeparatorChar}Target");
